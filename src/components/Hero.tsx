                  ...
                  <div className="flex flex-col items-start gap-8 mt-12 md:mt-16">
                    ...
                    >
                      <Link 
                        ...
                        className="group relative inline-flex items-center gap-4 sm:gap-6 bg-davic-primary text-white pl-8 sm:pl-10 pr-6 sm:pr-8 py-4 sm:py-5 text-[9px] sm:text-[10px] md:text-xs font-black uppercase tracking-[0.3em] hover:bg-white hov:text-davic-primary transition-all duration-500 shadow-[0_20px_50px_rgba(220,38,38,0.3)]"
                      >
