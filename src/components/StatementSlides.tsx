          ...
          >
            ...
            <div className="lg:w-1/2 space-y-12">
               <div className="flex items-center gap-4 text-davic-primary">
                  <span className="text-[10px] font-black uppercase tracking-[0.5em]">Visionary Statement 0{index + 1}</span>
